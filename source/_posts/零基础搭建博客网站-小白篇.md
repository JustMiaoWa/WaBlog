...
tags:
  ...
  - 网站
categories: 网站
cover: 'http://image.wazicode.top/blog/202305222258424.jpg'
abbrlink: f122fc14
...
![image-20230504001616849](http://image.wazicode.top/blog/202305040016956.png)

连接好之后，运行宝塔官网所提示的命令，根据你的Liunx系统。注意哦，必须是纯净的系统（之前没有安装过**Apache/Nginx/php/MySQL**服务的）

![image-20230504001930259](http://image.wazicode.top/blog/202305040019352.png)

安装好之后，会出现如下画面

![image-20230504002217016](http://image.wazicode.top/blog/202305040022099.png)

根据提示的外网面板地址、用户名、密码，在浏览器输入外网地址，再输入账号，密码，就进入了你的宝塔了

类似这样

![image-20230504002432522](http://image.wazicode.top/blog/202305040024801.png)

进入之后，你需要更改你的安全入口、账号和密码，因为之前都是随机生成的，你需要更改成方便你记忆的

![image-20230504002731890](http://image.wazicode.top/blog/202305040027095.png)
...
![image-20230504003353303](http://image.wazicode.top/blog/202305040033425.png)
...
![image-20230504235304743](http://image.wazicode.top/blog/202305042353853.png)

双击安装包，点击Next，勾选使用许可协议，点击Next，选择安装位置（可根据个人情况更换路径）

![image-20230504235936111](http://image.wazicode.top/blog/202305042359179.png)
...
![image-20230505000658410](http://image.wazicode.top/blog/202305050006469.png)
...
![image-20230505001339487](http://image.wazicode.top/blog/202305050013556.png)
...
![image-20230505003033305](http://image.wazicode.top/blog/202305050030365.png)

**添加环境变量**

将你的node_global文件夹添加到Path环境变量中

![image-20230505003324151](http://image.wazicode.top/blog/202305050033227.png)
...
![image-20230505003525886](http://image.wazicode.top/blog/202305050035951.png)
...
![image-20230505002024543](http://image.wazicode.top/blog/202305050020603.png)
...
![image-20230506003211473](http://image.wazicode.top/blog/202305060032544.png)
...
![image-20230506003703750](http://image.wazicode.top/blog/202305060037800.png)

打开浏览器，输入：localhost:4000，恭喜你，已经迈出了一大步了

![image-20230506003800701](http://image.wazicode.top/blog/202305060038012.png)
...
![image-20230521232842785](http://image.wazicode.top/blog/202305212328021.png)
